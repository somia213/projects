...
btn.onclick = function () {
  if (input1.value != "" && input2.value != "") {
    ...
    if (Regex1.test(input1.value) && Regex2.test(input2.value)) {
      ...
      if (
        Regex1.test(input1.value) == false &&
        Regex2.test(input2.value) == true
      ) {
        console.log("1f 2t");
        divFourth.innerHTML = `
                        <p class="p">Please enter a valid E-Mail</p>
                    `;
      } else if (
        Regex1.test(input1.value) == true &&
        Regex2.test(input2.value) == false
      ) {
        console.log("1t 2f");
        divFourth.innerHTML = `
        ...
        console.log("1f 2f");
        divFourth.innerHTML = `
                        <p class="p">Please enter a valid E-Mail and password</p>
                    `;
      }
    }
  } else {
    divFourth.innerHTML = `
        <p class="p">Please enter your E-Mail and password</p>
    `;
  }
};